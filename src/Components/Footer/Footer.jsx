...
export default function Footer() {
  return (
    <>
     <footer className="bg-gradient-to-br from-black from-35% via-red-500 via-70% to-green-700 to-70% min-h-screen relative">
                    ...
                    <div>
                        <a href="/">
                            <div className="flex items-center space-x-2 text-2xl font-medium">
                                ...
                                <span className="text-red-500">Spiro Spats</span>
                            </div>

                        </a>
                    </div>
                    <div className="max-w-md pr-16 text-md text-gray-200">Egyption company
                    </div>
                    <div className="flex space-x-2">
                        <a href="https://www.linkedin.com/in/assem-ayman-abdelfatah-831662262/" target="_blank" className="text-gray-200 hover:text-gray-200">
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" className="mt-6 space-y-4">
                                <li>
                                    <a href="/aiplatform"
                                        className="text-md leading-6 text-gray-300 hover:text-gray-50">Taste
                                    </a>
                                </li>
                                <li>
                                    <a href="/aialgorithms"
                                        className="text-md leading-6 text-gray-300 hover:text-gray-50">Personal impact
                                    </a>
                                </li>
                                <li>
